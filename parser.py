...
NONTERMINALS = """
S -> NP VP | S Conj S | S Conj VP | S P NP | NP P NP
NP -> N | Det NP | P NP | Adj NP | Adv NP | Conj NP | N Adv | Det N
VP -> V | V NP | Adv NP | V Adv
"""
...
def np_chunk(tree):
    ...
    for subtree in parented_tree.subtrees():
        if subtree.label() == "N":
            parent_tree = subtree.parent()
            result.append(parent_tree)
    return result
